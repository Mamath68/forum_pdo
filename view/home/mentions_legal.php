...
<p><b>Client :</b> tout professionnel ou personne physique capable au sens des articles 1123 et suivants du Code civil,
    ...
    <b>Prestations et Services :</b> <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> met à
...
<p><b>Informations clients :</b> Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données
    personnelles susceptibles d’être détenues par <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> pour la gestion de votre compte, de
...
<p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il est
    précisé aux utilisateurs du site internet <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> l'identité des différents
    intervenants dans le cadre de sa réalisation et de son suivi:
</p>
<p><strong>Propriétaire</strong> : Mathieu Stamm – 10 avenue de Bruxelles 68350 BRUNSTATT-DIDENHEIM<br>
...
<p>L’utilisation du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> implique
    ...
    d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> sont donc invités à les consulter de
    manière régulière.</p>

<p>Ce site internet est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
    maintenance technique peut être toutefois décidée par <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>, qui s’efforcera alors de communiquer
...
<p>Le site internet <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> a pour objet de
    fournir une information concernant l’ensemble des activités de la société.
    <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’efforce de fournir sur le site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> des informations aussi précises que
...
<p>Toutes les informations indiquées sur le site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> sont données à titre indicatif, et
    sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ne sont pas exhaustifs. Ils sont
...
<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> et l’hébergeur ne pourront être tenus
...
<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> est propriétaire des droits de
    ...
    quel que soit le moyen ou le procédé utilisé, est interdite, sauf autorisation écrite préalable de : <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>.</p>
...
<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> agit en tant qu’éditeur du site. <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> est responsable de la qualité et de
...
<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ne pourra être tenu responsable des
    dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site internet <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>, et résultant soit de l’utilisation
    d’un matériel ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
    incompatibilité.</p>

<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ne pourra également être tenu
    ...
    applicable en France, en particulier aux dispositions relatives à la protection des données. Le cas échéant, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> se réserve également la possibilité
...
<p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et de sa
    navigation sur le Site, le responsable du traitement des Données Personnelles est : Mathieu Stamm. <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>est représenté par Mathieu Stamm, son
    représentant légal</p>

<p>En tant que responsable du traitement des données qu’il collecte, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’engage à respecter le cadre des
    ...
    réalité.
    Chaque fois que <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> traite des Données
    Personnelles, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> prend toutes les mesures
    raisonnables pour s’assurer de l’exactitude et de la pertinence des Données Personnelles au regard des finalités
    pour lesquelles <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> les traite.</p>

<h3>7.2 Finalité des données collectées</h3>

<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> est susceptible de traiter tout ou
...
<p><a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ne commercialise pas vos données
...
<ul>
    ...
    <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> devra communiquer (ou non) ses
...
<p>Dès que <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> a connaissance du décès d’un
    Utilisateur et à défaut d’instructions de sa part, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’engage à détruire ses données, sauf
    si leur conservation s’avère nécessaire à des fins probatoires ou pour répondre à une obligation légale.</p>

<p>Si l’Utilisateur souhaite savoir comment <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> utilise ses Données Personnelles,
    demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut contacter <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> par écrit à l’adresse suivante : </p>

Mathieu Stamm – DPO, Mathieu Stamm <br>
10 avenue de Bruxelles 68350 BRUNSTATT-DIDENHEIM.

<p>Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> corrige, mette à jour ou supprime, en
    s’identifiant précisément avec une copie d’une pièce d’identité (carte d’identité ou passeport). </p>

<p>
    Les demandes de suppression de Données Personnelles seront soumises aux obligations qui sont imposées à <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> par la loi, notamment en matière de
    conservation ou d’archivage des documents. Enfin, les Utilisateurs de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> peuvent déposer une réclamation
    auprès des autorités de contrôle, et notamment de la CNIL (https://www.cnil.fr/fr/plaintes).</p>

<h3>7.4 Non-communication des données personnelles</h3>

<p>
    <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’interdit de traiter, héberger ou
    transférer les Informations collectées sur ses Clients vers un pays situé en dehors de l’Union européenne ou reconnu
    comme « non adéquat » par la Commission européenne sans en informer préalablement le client. Pour autant, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> reste libre du choix de ses
...
<p>
    <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> s’engage à prendre toutes les
    ...
    des Informations du Client est portée à la connaissance de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>, celle-ci devra dans les meilleurs
    délais informer le Client et lui communiquer les mesures de corrections prises. Par ailleurs <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ne collecte aucune « données
    sensibles ».
</p>

<p>
    Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> et des sous-traitants (prestataires
...
<p>
    ...
    personnes susceptibles d’avoir accès aux données des Utilisateurs de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> sont principalement les agents de
...
<p>
    Aucune information personnelle de l'utilisateur du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> n'est publiée à l'insu de
    ...
    conservation et de modification des données vis à vis de l'utilisateur du site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>.</p>

<h3>Sécurité</h3>

<p>
    Pour assurer la sécurité et la confidentialité des Données Personnelles et des Données Personnelles de Santé, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> utilise des réseaux protégés par des
    dispositifs standards tels que par pare-feu, la pseudonymisation, l’encryption et mot de passe. </p>

<p>
    Lors du traitement des Données Personnelles, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>prend toutes les mesures raisonnables
    visant à les protéger contre toute perte, utilisation détournée, accès non autorisé, divulgation, altération ou
    destruction.</p>

<h2>9. Liens hypertextes « cookies » et balises (“tags”) internet</h2>
<p>
    Le site <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> contient un certain nombre de
    liens hypertextes vers d’autres sites, mis en place avec l’autorisation de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>. Cependant, <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> n’a pas la possibilité de vérifier le
...
<p>
    ...
    effectuées. Ces informations permettent à <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> d’améliorer le contenu du Site, de la
...
<p>
    ...
    peuvent être limitées. Cela pourrait également être le cas lorsque <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> ou l’un de ses prestataires ne peut
...
<p>
    ...
    par l’Utilisateur (ii) de l’impossibilité pour <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> d’enregistrer ou de consulter les
    ...
    Cookies.</p>
<p>
    À tout moment, l’Utilisateur peut faire le choix d’exprimer et de modifier ses souhaits en matière de Cookies. <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> pourra en outre faire appel aux
...
<p>
    ...
    navigation sur le Site Internet ou l’application mobile de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>. À tout moment, l’Utilisateur peut
    néanmoins revenir sur son consentement à ce que <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a> dépose ce type de cookies.</p>
...
<p>
    ...
    Internet grâce à ces balises, constituer des rapports sur l’activité du Site à l’attention de <a href="http://localhost/pro/sql/forum/">http://localhost/pro/sql/forum/</a>, et fournir d’autres services
...
<p>
    ...
    compétents de Mulhouse</p>

<?php
$title = "Mentions Légaux";
